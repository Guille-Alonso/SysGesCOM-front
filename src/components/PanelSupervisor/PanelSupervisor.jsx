        ...
        <div className='layoutHeight container'>
            <div className='row'>
                ...
                <div className='col-6 text-center'>
                    <h2 className='tituloTablasRelevamiento mt-1 ps-4 text-light'>USUARIOS</h2>
                    ...
                    <div className='contenedorTablaPanel'>
                        ...
                        <table
                            className=" table text-light tablaPanelSupervisor"
                        >
                            <tbody>
                                {
                                    loading ?
                ...
                <div className='col-6 text-center'>
                    <h2 className='tituloTablasRelevamiento mt-1 ps-4 text-light'>USUARIOS PARA RELEVAMIENTO</h2>
                        <div className='text-light d-flex justify-content-between mb-1'>
                        <th className="ps-5" scope="col">
                            Usuario
                        </th>
